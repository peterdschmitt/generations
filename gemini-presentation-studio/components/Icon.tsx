...
interface IconProps {
  name: 'image' | 'sparkles' | 'bulb' | 'video' | 'play' | 'settings' | 'close' | 'folder' | 'trash' | 'chevron-left' | 'chevron-right' | 'chevron-up' | 'chevron-down' | 'file-text' | 'linkedin' | 'twitter' | 'instagram' | 'mail';
  className?: string;
}
